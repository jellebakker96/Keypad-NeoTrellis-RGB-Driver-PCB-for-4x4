...
arduino_vid = [90250] # serial devices with these vid/pid numbers will also be seen as a arduino
arduino_pid = [328220] # serial devices with these vid/pid numbers will also be seen as a arduino