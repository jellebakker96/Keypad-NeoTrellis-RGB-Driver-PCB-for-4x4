...
InfoBeforeFile=C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeSetup\Hallo.txt
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=dialog
OutputDir=C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeSetup\dist
...
Source: "C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeEXE\dist\config.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeEXE\dist\debugging.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeEXE\dist\debugging_off.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeEXE\dist\debugging_on.ico"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Gedeeld\Private Projects\Keypad-V2\Windows Code\MakeEXE\dist\log.txt"; DestDir: "{app}"; Flags: ignoreversion
